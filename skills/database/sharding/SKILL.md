...
Design and operate reliable, performant database systems using sharding best practices.

## Core Responsibilities

- Apply sharding patterns to production-grade data systems.
...
2. Design the sharding approach to satisfy those requirements.
